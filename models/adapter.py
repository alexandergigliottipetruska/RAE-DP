...
class TrainableAdapter(nn.Module):
    ...
    def noise_augment(self, z_bar, tau=0.8, training=True):
        """
...
if __name__ == '__main__':    
    ...
    z_tilde_train = adapter.noise_augment(z_bar, tau=0.8, training=True)
    ...
    z_tilde_eval = adapter.noise_augment(z_bar, tau=0.8, training=False)
